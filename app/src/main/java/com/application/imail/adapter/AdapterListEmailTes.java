...
public class AdapterListEmailTes extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements Filterable {
    ...
    public AdapterListEmailTes(Context context, List<listemail> items) {
        this.items = items;
        ctx = context;
